...
if __name__ == "__main__":
    ...
    # Strategy B: real expansion (needs internet for WQP API)
    try:
    ...
    # Strategy C: noise + jitter (always works)
    dir_c = strategy_c_augmentation()

    # Strategy A: synthetic (always works)
    ...
    print("\nTo train with augmented data, modify WQ_DIR in train_model.py")
    print("to point at one of these directories.")
